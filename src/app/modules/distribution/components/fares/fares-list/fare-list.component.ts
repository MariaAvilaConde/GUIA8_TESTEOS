...
export class FareListComponent implements OnInit {
  ...
  loadFares(): void {
    ...
    // Cargar todas las tarifas y luego filtrar por organización del usuario
    ...
    request$.subscribe({
      next: (data) => {
        ...
        // Filtrar solo las tarifas del usuario actual y su organización
  ...
  filterFaresByUser(): void {
    ...
    // Ordenar por código de tarifa (alfabéticamente)
    this.fares.sort((a, b) => {
