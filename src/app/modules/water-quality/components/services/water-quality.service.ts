...
import { createDaily_records, dayliRecors, QualityIncident, QualityIncidentCreateRequest, QualityIncidentUpdateRequest, QualityTest, QualityTestUpdateRequest, testing_points, UpdateDaily_records } from 'app/core/models/water-quality.model';
